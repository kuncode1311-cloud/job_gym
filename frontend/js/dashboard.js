  ...
  if (statsContainer) {
    statsContainer.innerHTML = `
      <div class="stat-card">
        ...
        <span class="stat-value text-white">156 người</span>
      </div>
      <div class="stat-card">
        <span class="stat-label">Check-in hôm nay</span>
        <span class="stat-value text-green">84 lượt</span>
      </div>
      <div class="stat-card">
        <span class="stat-label">Booking hôm nay</span>
        <span class="stat-value text-blue">12 lịch hẹn</span>
      </div>
      <div class="stat-card">
        <span class="stat-label">Doanh thu tháng</span>
        <span class="stat-value text-red">45.200.000đ</span>
      </div>
    `;
  }
}
